...
uint32_t Flash_GetSector( uint32_t addr )
{
  ...
  else /*((addr >= FLASH_ADDR_SECTOR_7) && (addr < FLASH_ADDR_SECTOR_END)) */ return FLASH_Sector_7;
}
/*=====================================================================================================*/
/*=====================================================================================================*
...
**輸入 : eraseSector
**輸出 : status
**使用 : Flash_ErasePage(Flash_GetSector(FLASH_ADDR_SECTOR_3), 8);
**=====================================================================================================*/
/*=====================================================================================================*/
