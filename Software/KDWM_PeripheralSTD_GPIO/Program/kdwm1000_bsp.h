...
#define LED_R_GPIO_CLK_ENABLE()   RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC, ENABLE)
...
#define LED_G_GPIO_CLK_ENABLE()   RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC, ENABLE)
...
#define LED_B_GPIO_CLK_ENABLE()   RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC, ENABLE)
...
#define KEY_GPIO_CLK_ENABLE()     RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA, ENABLE)
#define KEY_Read()                (__GPIO_READ(KEY_GPIO_PORT, KEY_PIN) == KEY_PIN)
/*====================================================================================================*/
/*====================================================================================================*/
void KDWM_GPIO_Config( void );
void KDWM_TIM_Config( void );
/*====================================================================================================*/
/*====================================================================================================*/
#endif
